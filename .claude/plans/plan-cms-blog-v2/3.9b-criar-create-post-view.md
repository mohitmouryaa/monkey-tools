...
# ✅ 3.9b — Criar view `create-post-view.tsx`

## Contexto
View de criação. Botão back, título, e `<PostForm />` com handler para `useCreatePost`.

## Detalhe técnico
Criar `apps/web/modules/dashboard/ui/views/create-post-view.tsx`:
...
## Arquivos tocados
- `apps/web/modules/dashboard/ui/views/create-post-view.tsx` — criar.
