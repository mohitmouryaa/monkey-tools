...
- Páginas visitadas: **41**
- Páginas com inglês detectado: **0**
- Erros de navegação: **2**

## ✅ Nenhuma página com inglês detectado pela heurística.
...
- `http://localhost:3000/ferramentas/pdf` — page.goto: Timeout 20000ms exceeded.
Call log:
[2m  - navigating to "http://localhost:3000/ferramentas/pdf", waiting until "networkidle"[22m

- `http://localhost:3000/ferramentas/pdf/comprimir-pdf` — page.goto: Timeout 20000ms exceeded.
Call log:
[2m  - navigating to "http://localhost:3000/ferramentas/pdf/comprimir-pdf", waiting until "networkidle"[22m
...
- ❌ [0] `http://localhost:3000/ferramentas/pdf` — (sem título) 
- ✅ [200] `http://localhost:3000/ferramentas/imagem` — Ferramentas de Imagem - Ferramentas Online Grátis | pdfs.com.br 
- ✅ [200] `http://localhost:3000/ferramentas/geradores` — Geradores - Ferramentas Online Grátis | pdfs.com.br 
- ✅ [200] `http://localhost:3000/ferramentas/texto` — Texto e Dados - Ferramentas Online Grátis | pdfs.com.br 
- ❌ [0] `http://localhost:3000/ferramentas/pdf/comprimir-pdf` — (sem título) 
