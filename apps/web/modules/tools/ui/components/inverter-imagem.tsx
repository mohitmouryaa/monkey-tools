...
export default function FlipImage() {
    ...
    async (type: "horizontal" | "vertical" | "both") => {
      ...
      try {
        ...
        if (type === "horizontal") {
          ...
          toast.success(currentFlip.horizontal ? "Inversão horizontal removida" : "Invertido horizontalmente!");
        } else if (type === "vertical") {
          setCurrentFlip((prev) => ({ ...prev, vertical: !prev.vertical }));
          toast.success(currentFlip.vertical ? "Inversão vertical removida" : "Invertido verticalmente!");
        } else {
          setCurrentFlip((prev) => ({ horizontal: !prev.horizontal, vertical: !prev.vertical }));
          toast.success("Invertido em ambas as direções!");
        }
      } catch (error) {
        console.error("Erro ao inverter a imagem:", error);
        toast.error("Falha ao inverter imagem. Tente novamente.");
      } finally {
  ...
  const resetFlip = useCallback(() => {
    setCurrentFlip({ horizontal: false, vertical: false });
    toast.success("Inversões reiniciadas!");
  }, []);
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {imageSrc && (
                <div className="relative h-96 lg:h-125 bg-muted rounded-lg overflow-hidden">
                  <Image
                    src={imageSrc}
                    alt="Pré-visualização da imagem invertida"
                    fill
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8 space-y-6">
                ...
                <div className="bg-card border rounded-lg p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between p-2 bg-muted rounded">
                      ...
                      >
                        {currentFlip.horizontal ? "Invertido" : "Normal"}
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-2 bg-muted rounded">
                      ...
                      >
                        {currentFlip.vertical ? "Invertido" : "Normal"}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <Alert>
                  ...
                  <AlertTitle>Dicas de Inversão</AlertTitle>
                  <AlertDescription className="text-sm">
                    <ul className="mt-2 space-y-1">
                      <li>• Inversão horizontal espelha da esquerda para a direita</li>
                      <li>• Inversão vertical espelha de cima para baixo</li>
                      <li>• Combine ambos para rotação de 180°</li>
                      <li>• Baixe quando estiver satisfeito</li>
                    </ul>
                  </AlertDescription>
                </Alert>
              </div>
