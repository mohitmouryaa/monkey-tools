...
export default function AddWatermarkPDF() {
  ...
  const applyWatermark = async () => {
    ...
    try {
      ...
      toast.success(`Marca d'água aplicada nas páginas ${startPage}-${endPage}!`);
    } catch (error) {
      console.error("Erro ao aplicar marca d'água:", error);
      toast.error("Falha ao aplicar marca d'água. Tente novamente.");
    } finally {
      setIsProcessing(false);
    }
  };
              ...
              <div className="sticky space-y-6 top-8">
                ...
                <div className="p-6 space-y-6 border rounded-lg bg-card">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-lg font-semibold">Configurações da Marca d'Água</h3>
                  </div>
                  ...
                  {/* Opacity */}
                  <div className="space-y-2">
                    <Label>Opacidade: {Math.round(settings.opacity * 100)}%</Label>
                    <Slider
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      A marca d'água será aplicada nas páginas {pageRange.from}-{pageRange.to}
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="over">Sobre o Texto</SelectItem>
                        <SelectItem value="under">Sob o Texto</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <Alert>
                  ...
                  <AlertTitle>Dicas de Marca d'Água</AlertTitle>
                  <AlertDescription className="text-sm">
                    <ul className="mt-2 space-y-1">
                      <li>• Ajuste a opacidade para marcas d'água sutis</li>
                      <li>• Use rotação para efeitos diagonais</li>
                      <li>• A prévia atualiza automaticamente</li>
                      <li>• A marca d'água é aplicada em todas as páginas</li>
                    </ul>
                  </AlertDescription>
                </Alert>
              </div>
