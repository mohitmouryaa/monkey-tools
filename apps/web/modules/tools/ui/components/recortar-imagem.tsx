...
export default function CropImage() {
  ...
  const handleCrop = useCallback(async () => {
    ...
    try {
      ...
      toast.error("Falha ao recortar imagem. Tente novamente.");
    } finally {
              ...
              <div className="sticky top-8 space-y-6">
                ...
                <div className="bg-card border rounded-lg p-6 space-y-6">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-lg font-semibold">Configurações de Recorte</h3>
                  </div>

                  {/* Crop Info */}
                  {completedCrop && (
                    <div className="space-y-2 p-3 bg-muted rounded-lg">
                      <h4 className="text-sm font-medium">Informações da Seleção</h4>
                      <div className="text-xs text-muted-foreground space-y-1">
                        <div>Largura: {Math.round(completedCrop.width)}px</div>
                        <div>Altura: {Math.round(completedCrop.height)}px</div>
                        <div>Proporção: {(completedCrop.width / completedCrop.height).toFixed(2)}</div>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <Alert>
                  ...
                  <AlertTitle>Dicas de Recorte</AlertTitle>
                  <AlertDescription className="text-sm">
                    <ul className="mt-2 space-y-1">
                      <li>• Arraste os cantos para redimensionar proporcionalmente</li>
                      <li>• Arraste as laterais para redimensionar em uma direção</li>
                      <li>• Arraste o centro para reposicionar</li>
                      <li>• Clique em "Recortar Imagem" quando estiver pronto</li>
                    </ul>
                  </AlertDescription>
                </Alert>
              </div>
        ...
        <section className="max-w-4xl mx-auto my-8">
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-semibold">Imagem Recortada</h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {/* Cropped */}
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-muted-foreground">Recortada</h3>
                <div className="relative min-h-50 max-h-100 bg-muted rounded-lg overflow-hidden">
                  <Image
