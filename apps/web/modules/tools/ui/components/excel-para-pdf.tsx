...
export default function ExcelToPDF() {
  ...
  const convertToPdf = async () => {
    ...
    try {
      ...
      if (!finalPdfBlob) {
        throw new Error("Nenhuma página de PDF foi gerada.");
      }
    ...
    <div className="w-full">
      ...
      <section aria-labelledby="upload-section" className="max-w-3xl mx-auto">
        {files.length === 0 ? (
          <FileUpload
            ...
            label="Enviar Arquivos Excel"
            description="Selecione arquivos Excel (.xlsx, .xls) para converter em PDF"
            disclaimer="Arquivos são processados com segurança no seu navegador"
          />
        ) : (
                ...
                <div className="p-6 border-2 border-green-300 shadow-lg rounded-xl bg-linear-to-br from-green-50 to-green-100 dark:from-green-950/30 dark:to-green-900/20 dark:border-green-700">
                  ...
                  <div className="grid grid-cols-1 gap-4 mb-6 md:grid-cols-2">
                    <div className="p-3 text-center rounded-lg bg-white/50 dark:bg-black/20">
                      ...
                      <p className="text-sm text-muted-foreground">Planilhas Convertidas</p>
                    </div>
                    <div className="p-3 text-center rounded-lg bg-white/50 dark:bg-black/20">
      ...
      {isConverting && (
        <div className="max-w-3xl mx-auto mt-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium">Convertendo planilhas para PDF...</span>
      ...
      <Alert className="max-w-3xl mx-auto mt-6 text-blue-800 border-blue-200 bg-blue-50 dark:bg-blue-950/20 dark:border-blue-800 dark:text-blue-200">
        ...
        <AlertDescription className="text-blue-700 dark:text-blue-300">
          Planilhas Excel são convertidas para PDF em orientação paisagem para acomodar mais colunas.
        </AlertDescription>
      </Alert>
    </div>
  );
