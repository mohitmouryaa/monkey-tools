  ...
  const handleFilesSelected = useCallback(async (newFiles: File[]) => {
    ...
    for (const file of newFiles) {
      try {
        ...
        console.error(`Falha ao processar ${file.name} para visualização:`, error);
        toast.error(`Falha ao carregar ${file.name} para visualização`);
      }
    }
      ...
      <section aria-labelledby="upload-section" className="max-w-3xl mx-auto">
        {files.length === 0 ? (
          <FileUpload
            ...
            label="Enviar Imagem HEIC"
            description="Selecione uma imagem HEIC/HEIF para converter em JPG"
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 border rounded-lg border-emerald-200 bg-emerald-50 dark:bg-emerald-950/20 dark:border-emerald-800">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="font-semibold text-emerald-800 dark:text-emerald-200">Imagem Convertida com Sucesso!</h4>
                  </div>
                ...
                <div className="flex flex-col gap-6 md:grid md:grid-cols-2">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-muted-foreground">HEIC Original</span>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-emerald-600 dark:text-emerald-400">JPG Convertido</span>
