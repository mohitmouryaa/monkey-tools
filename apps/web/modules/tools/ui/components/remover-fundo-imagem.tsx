    ...
    try {
      ...
      for (const uploadedFile of files) {
        try {
          ...
          console.error(`Falha ao processar ${uploadedFile.file.name}:`, error);
          toast.error(`Falha ao remover fundo de ${uploadedFile.file.name}`);
        }
      ...
      toast.error(error instanceof Error ? error.message : "Falha na remoção de fundo");
    } finally {
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 border border-green-200 rounded-lg bg-green-50 dark:bg-green-950/20 dark:border-green-800">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="font-semibold text-green-800 dark:text-green-200">Fundo Removido com Sucesso!</h4>
                  </div>
                  <div className="flex flex-col gap-3 mt-2 sm:flex-row sm:items-center sm:justify-between">
                    <p className="text-sm text-green-700 dark:text-green-300">Sua imagem está pronta para download.</p>
                ...
                <div className="flex flex-col gap-6 md:grid md:grid-cols-2">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-muted-foreground">Imagem Original</span>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-green-600 dark:text-green-400">Fundo Removido</span>
      ...
      {isProcessing && (
        <div className="max-w-3xl mx-auto mt-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium">Removendo fundo...</span>
