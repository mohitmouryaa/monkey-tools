    ...
    <div className="w-full">
      ...
      <section aria-labelledby="upload-section" className="max-w-3xl mx-auto">
        {files.length === 0 ? (
          <FileUpload
            ...
            label="Enviar Imagem PNG"
            description="Selecione uma imagem PNG para converter em JPG"
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 border border-orange-200 rounded-lg bg-orange-50 dark:bg-orange-950/20 dark:border-orange-800">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="font-semibold text-orange-800 dark:text-orange-200">Imagem Convertida com Sucesso!</h4>
                  </div>
                  <div className="flex flex-col gap-3 mt-2 sm:flex-row sm:items-center sm:justify-between">
                    <p className="text-sm text-orange-700 dark:text-orange-300">
                      Reduzido em {convertedImages[0]?.compressionRatio.toFixed(1)}% (
                ...
                <div className="flex flex-col gap-6 md:grid md:grid-cols-2">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-muted-foreground">PNG Original</span>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-orange-600 dark:text-orange-400">JPG Convertido</span>
      ...
      <Alert className="max-w-3xl mx-auto mt-6 text-yellow-800 border-yellow-200 bg-yellow-50 dark:bg-yellow-950/20 dark:border-yellow-800 dark:text-yellow-200">
        ...
        <AlertDescription className="text-yellow-700 dark:text-yellow-300">
          A conversão de PNG para JPG usa compressão com perdas que pode reduzir a qualidade da imagem, mas diminui significativamente o tamanho do arquivo.
        </AlertDescription>
      </Alert>
    </div>
  );
