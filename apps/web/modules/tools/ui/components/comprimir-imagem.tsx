    ...
    try {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        try {
          ...
          console.error(`Falha ao comprimir ${uploadedFile.file.name}:`, error);
          toast.error(`Falha ao comprimir ${uploadedFile.file.name}`);
        }
      }
      ...
      toast.error(error instanceof Error ? error.message : "Falha na compressão da imagem");
    } finally {
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 border border-blue-200 rounded-lg bg-blue-50 dark:bg-blue-950/20 dark:border-blue-800">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="font-semibold text-blue-800 dark:text-blue-200">Imagem Comprimida com Sucesso!</h4>
                  </div>
                  <div className="flex flex-col gap-3 mt-2 sm:flex-row sm:items-center sm:justify-between">
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      Reduzido em {compressedImages[0]?.compressionRatio.toFixed(1)}% (
                ...
                <div className="flex flex-col gap-6 md:grid md:grid-cols-2">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-blue-600 dark:text-blue-400">Imagem Comprimida</span>
