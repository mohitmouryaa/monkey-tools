      ...
      {/* Upload Section */}
        <section aria-labelledby="upload-section" className="max-w-3xl mx-auto">
          {files.length === 0 ? (
            <FileUpload
              ...
              description="Select a JPG image to convert to PNG"
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 border border-purple-200 rounded-lg bg-purple-50 dark:bg-purple-950/20 dark:border-purple-800">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h4 className="font-semibold text-purple-800 dark:text-purple-200">Image Converted Successfully!</h4>
                    </div>
                    <div className="flex flex-col gap-3 mt-2 sm:flex-row sm:items-center sm:justify-between">
                      <p className="text-sm text-purple-700 dark:text-purple-300">
                        Converted to PNG format ({formatFileSize(convertedImages[0]?.convertedBlob.size || 0)})
                      </p>
                  ...
                  <div className="flex flex-col gap-6 md:grid md:grid-cols-2">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-muted-foreground">Original JPG</span>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-purple-600 dark:text-purple-400">Converted PNG</span>
        ...
        <Alert className="max-w-3xl mx-auto mt-6 text-yellow-800 border-yellow-200 bg-yellow-50 dark:bg-yellow-950/20 dark:border-yellow-800 dark:text-yellow-200">
          ...
          <AlertDescription className="text-yellow-700 dark:text-yellow-300">
            JPG to PNG conversion preserves image quality but may result in larger file sizes due to PNG's lossless compression.
          </AlertDescription>
        </Alert>
      </div>
  );
