        ...
        canvas.toBlob(
          (blob) => {
            if (blob) {
              ...
              reject(new Error("Falha ao converter para JPG"));
            }
          },
          "image/jpeg",
          0.9,
    ...
    <div className="w-full">
      ...
      <section aria-labelledby="upload-section" className="max-w-3xl mx-auto">
        {files.length === 0 ? (
          <FileUpload
            ...
            label="Enviar Imagem WebP"
            description="Selecione uma imagem WebP para converter em JPG"
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 border rounded-lg border-cyan-200 bg-cyan-50 dark:bg-cyan-950/20 dark:border-cyan-800">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="font-semibold text-cyan-800 dark:text-cyan-200">Imagem Convertida com Sucesso!</h4>
                  </div>
                    ...
                    <p className="text-sm text-cyan-700 dark:text-cyan-300">
                      {(() => {
                        ...
                        return firstConverted.sizeChange > 0
                          ? `Aumentou em ${firstConverted.sizeChange.toFixed(1)}%`
                          : `Reduzido em ${Math.abs(firstConverted.sizeChange).toFixed(1)}%`;
                ...
                <div className="flex flex-col gap-6 md:grid md:grid-cols-2">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-muted-foreground">WebP Original</span>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-cyan-600 dark:text-cyan-400">JPG Convertido</span>
      ...
      <Alert className="max-w-3xl mx-auto mt-6 text-yellow-800 border-yellow-200 bg-yellow-50 dark:bg-yellow-950/20 dark:border-yellow-800 dark:text-yellow-200">
        ...
        <AlertDescription className="text-yellow-700 dark:text-yellow-300">
          A conversão de WebP para JPG oferece melhor compatibilidade. O formato JPG pode ter características de compressão
