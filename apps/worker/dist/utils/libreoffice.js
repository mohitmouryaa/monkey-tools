...
async function optimizePdf(inputPath) {
...
export async function convertToPdf(inputPath, outputDir) {
...
async function fallbackToPdfToText(inputPath, outputPath) {
...
export async function convertToWord(inputPath, outputDir) {
    ...
    return new Promise((resolve, reject) => {
        ...
        execFile("soffice", args, { timeout }, async (error) => {
            ...
            const findAndRenameOutput = async () => {
